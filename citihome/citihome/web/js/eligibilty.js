...
function getDSR() {
    ...
    belowDSR.innerHTML = "Total Debt Servicing Ratio (%) <h1><strong>" + dsr + "</strong></h1><small style='color:#007bff'>*Net Debt/ Net Income should be lower than TSDR.</small>";
    return dsr;
}
...
function getNetDebtOverNetIncome(){
    ...
    var output = '-';
    if (annualIncome != 0) {
        output = parseFloat(annualDebt/annualIncome).toFixed(2);
    }
